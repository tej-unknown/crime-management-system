...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  $existssql= "SELECT * FROM user_view WHERE username= '$username' and email = '$email'";
  ...
  {
    $sql="INSERT INTO user_view ( `username`, `email`, `password`) VALUES ( '$username', '$email', '$password1')";
...
?>
<div class="container"  >
  <h1 class="text-center"  >REGISTER TO CrimelessZone to view only</h1>
</div> 
<div class="container col-md-6">
  ...
  <p>Alredy registered login here: <a href="login_user.php">login</a></p>
</form>
</div>
