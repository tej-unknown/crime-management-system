...
$sql = "UPDATE `fir` SET `status` = '$status' WHERE `comp_no` ='$comp_no';";
...
<div class="container"  >
  <h1 class="text-center"  >update charge filled  status</h1>
</div> 
...
<div class="form-group">
  ...
  <div class="form-group">
    <label for="status">is the charge sheet filled</label>
