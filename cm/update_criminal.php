...
if($_SERVER["REQUEST_METHOD"] == "POST"){
 ...
 if(($no) == 0){
  {
  echo'<script>alert("this criminal number dosent exists,please give a validate phone number")</script>';
  ?>
  <script>
...
$sql = "UPDATE `criminal` SET `status` = '$status' WHERE `criminal_phone_no` ='$criminal_phone_no';";
...
<div class="container"  >
  <h1 class="text-center"  >update criminal  status</h1>
</div> 
<form action="update_criminal.php" method="post">
...
<div class="form-group">
  ...
  <div class="form-group">
    <label for="status">the status of criminal</label>
    <input type="text"    name="status"  class="form-control" id="status" placeholder="bailed/released/custody/arrested" required>
  </div>
